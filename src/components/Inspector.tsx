    ...
    <div className="inspector-properties">
      ...
      <div className="property-group has-tooltip">
        ...
        <div className="field-tooltip">
          The aspect ratio of this scene (e.g., 16:9, 4:3).
        </div>
      </div>
      <div className="property-group has-tooltip">
        ...
        <div className="field-tooltip">
          The background image displayed for this scene.
        </div>
      </div>
      <div className="property-group has-tooltip">
        ...
        <div className="property-value">
          ...
          {scene.music && (
            <div className="file-info">
              ...
              <button onClick={handleRemoveMusic} className="btn-remove-file">
                &times;
              </button>
            </div>
          )}
      ...
      <div className="property-group has-tooltip">
        ...
        />
        <div className="field-tooltip">
          Text which appears in the main textbox when this scene is entered. Use
    ...
    <div className="inspector-properties">
      ...
      <div className="property-group-row">
        <div className="property-group has-tooltip">
          ...
          />
          <div className="field-tooltip">
            Horizontal center position (0 to 1).
          </div>
        </div>
        ...
        <div className="property-group has-tooltip">
          ...
          />
          <div className="field-tooltip">
            Vertical center position (0 to 1).
          </div>
        </div>
      </div>
      ...
      <div className="property-group-row">
        <div className="property-group has-tooltip">
          ...
          />
          <div className="field-tooltip">
            Relative height of this element (1 = full scene height).
          </div>
        </div>
        ...
        <div className="property-value">
          ...
          {element.image && (
            <div className="file-info">
              ...
              <button
                onClick={handleRemoveElementImage}
                className="btn-remove-file"
              >
                &times;
              </button>
      ...
      <div className="property-group has-tooltip">
        ...
        <div className="field-tooltip">
          The scene to navigate to when this element is clicked.
        </div>
      </div>
      ...
      <div className="property-group has-tooltip">
        ...
        />
        <div className="field-tooltip">
          Text which appears in the main textbox when this element is clicked.
          Use newlines to separate multiple texts within the same message.
        </div>
      </div>
      ...
      <div className="property-group has-tooltip">
        ...
        <div className="property-value">
          ...
          {element.onClickSound && (
            <div className="file-info">
              ...
              <button onClick={handleRemoveSound} className="btn-remove-file">
                &times;
              </button>
            </div>
          )}
        ...
        <div className="field-tooltip">
          Plays this sound when this element is clicked.
        </div>
      </div>
        ...
        <div className="property-value">
          ...
          {element.onClickMusicChange && (
            <div className="file-info">
              ...
              <button
                onClick={handleRemoveMusicChange}
                className="btn-remove-file"
              >
                &times;
              </button>
      ...
      <div className="property-group-row has-tooltip">
        <label
          className="property-label-row switch-label"
          htmlFor={`highlight-${element.id}`}
        >
          Highlight on Hover
        </label>
        ...
        <div className="field-tooltip">
          If enabled, the element will glow when hovered.
        </div>
      </div>
